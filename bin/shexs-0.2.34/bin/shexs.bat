@REM shexs launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM SHEXS_config.txt found in the SHEXS_HOME.
...
set "CFG_FILE=%APP_HOME%\SHEXS_config.txt"
set CFG_OPTS=
...
set "APP_CLASSPATH="
set "APP_MAIN_CLASS=-jar "%APP_LIB_DIR%\es.weso.shexs-0.2.34-launcher.jar""
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running shexs.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !SHEXS_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
